                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <label class="custom-control custom-checkbox">
                                                    ...
                                                    <?php $category=$_GET['catid'];  // get the category?>      
                                                </li>
...
// Getting total number of pages
        $total_pages_sql ="SELECT COUNT(*) FROM tblfood where CategoryName='$category'";
        $result = mysqli_query($con,$total_pages_sql);
        $total_rows = mysqli_fetch_array($result)[0];
        $total_pages = ceil($total_rows / $no_of_records_per_page);
        $sql = "SELECT * FROM tblfood where CategoryName='$category' LIMIT $offset, $no_of_records_per_page";
...
<a href="login.php" class="btn theme-btn pull-center">Order Now</a>
<?php } else {?>
    <form method="post"> 
